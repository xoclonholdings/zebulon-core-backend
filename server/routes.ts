...
export function registerRoutes(app: any) {
	...
	app.post("/chat", (req: any, res: any) => {
			...
			let reply;
						...
						const userName = coreData.userName || "there";
						if (/hello|hi|hey/i.test(message)) {
							reply = `Hi ${userName}! It's great to hear from you. How can I help you today?`;
							...
							reply = `Good ${time}, ${userName}! What can I do for you?`;
						} else if (/how are you|how's it going|what's up/i.test(message)) {
							reply = `I'm doing well, thank you for asking${userName !== "there" ? ", " + userName : ""}! How can I assist you today?`;
							...
							reply = `Goodbye${userName !== "there" ? ", " + userName : ""}! Have a wonderful day. If you need anything else, just reach out.`;
						} else {
