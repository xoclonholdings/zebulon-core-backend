#!/bin/bash
# Robust tile launcher for ZED: starts backend and frontend, waits for both to be ready, never fails
BACKEND_SCRIPT=./scripts/zed-backend-dev.sh
BACKEND_HEALTH_URL="http://localhost:5100/api/health"
