...
var OLLAMA_BASE_URL = ((_a = process.env.OLLAMA_API_URL) === null || _a === void 0 ? void 0 : _a.replace(/\/api\/generate$/, '')) || 'http://localhost:11434';
function listOllamaModels() {
    return __awaiter(this, void 0, void 0, function () {
        var res, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, node_fetch_1.default)("".concat(OLLAMA_BASE_URL, "/api/tags"))];
                case 1:
                    res = _a.sent();
                    if (!res.ok)
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, node_fetch_1.default)("".concat(OLLAMA_BASE_URL, "/api/health"))];
                case 1:
                    res = _a.sent();
                    if (!res.ok)
