    ...
    chat: function (messages_1) {
        return __awaiter(this, arguments, void 0, function (messages, options) {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, fetch("".concat(OLLAMA_URL, "/api/chat"), {
                            method: 'POST',
                    ...
                    case 2: throw new (_a.apply(Error, [void 0, _e.sent()]))();
                    case 3: return [4 /*yield*/, res.json()];
                    case 4:
                        data = _e.sent();
                        return [2 /*return*/, data.response || ((_d = (_c = (_b = data.choices) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.message) === null || _d === void 0 ? void 0 : _d.content) || ''];
                }
            });
        });
    },
    chatStream: function (messages, options, stream) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, fetch("".concat(OLLAMA_URL, "/api/chat/stream"), {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify(__assign({ model: options.model || ZED_MODEL, messages: messages }, options)),
                        })];
