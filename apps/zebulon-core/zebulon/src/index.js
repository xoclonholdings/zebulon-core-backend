...
var PORT = Number(process.env.PORT || 3001); // Railway injects PORT at runtime
...
app.post('/chat', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        try {
            ...
            return [2 /*return*/, res.status(200).json({ reply: "Zed says: ".concat(message) })];
        }
        catch (err) {
            console.error('Chat error:', (err === null || err === void 0 ? void 0 : err.message) || err);
...
app.listen(PORT, function () {
    ...
    if (process.env.PORT) {
        console.log("[server] PORT from process.env.PORT: ".concat(process.env.PORT));
    }
    else {
