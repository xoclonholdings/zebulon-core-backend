...
function agentChat(prompt_1) {
    return __awaiter(this, arguments, void 0, function (prompt, history, ollamaModel) {
        var messages, completion, err_1;
        var _a, _b;
        if (history === void 0) { history = []; }
        if (ollamaModel === void 0) { ollamaModel = 'llama3-agent'; }
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                return [2 /*return*/, (0, ollamaClient_1.ollamaChat)(prompt, history, ollamaModel)];
            }
        });
    });
}
