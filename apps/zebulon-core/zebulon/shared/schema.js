...
exports.messages = (0, pg_core_1.pgTable)("messages", {
    ...
    conversationId: (0, pg_core_1.varchar)("conversation_id").notNull().references(function () { return exports.conversations.id; }),
...
exports.scratchpadMemory = (0, pg_core_1.pgTable)("scratchpad_memory", {
    ...
    userId: (0, pg_core_1.varchar)("user_id").notNull().references(function () { return exports.users.id; }),
    conversationId: (0, pg_core_1.varchar)("conversation_id").references(function () { return exports.conversations.id; }),
    content: (0, pg_core_1.text)("content").notNull(),
...
exports.fileStorage = (0, pg_core_1.pgTable)("file_storage", {
    ...
    fileId: (0, pg_core_1.varchar)("file_id").notNull().references(function () { return exports.files.id; }),
...
exports.userRelations = (0, drizzle_orm_2.relations)(exports.users, function (_a) {
    var many = _a.many;
    return ({
...
exports.conversationRelations = (0, drizzle_orm_2.relations)(exports.conversations, function (_a) {
...
exports.messageRelations = (0, drizzle_orm_2.relations)(exports.messages, function (_a) {
    var one = _a.one;
    return ({
...
exports.fileRelations = (0, drizzle_orm_2.relations)(exports.files, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
        conversation: one(exports.conversations, {
